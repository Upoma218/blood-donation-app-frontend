            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <div className="flex space-x-4 mt-2">
                  ...
                  >
                    <FaFacebook className="text-xl hover:text-teal-500 transition duration-300" />
                  </Link>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <FaTwitter className="text-xl hover:text-teal-500 transition duration-300" />
                  </Link>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <FaInstagram className="text-xl hover:text-teal-500 transition duration-300" />
                  </Link>
                </div>
              </div>
            </div>
