      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="card card-side bg-base-100 shadow-xl flex flex-col lg:flex-row mx-auto">
          ...
          <div className="card-body w-full lg:w-1/2 p-6 lg:p-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3 text-white bg-teal-500 p-6 rounded-md">
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    >
                      <FaFacebook className="text-3xl hover:text-teal-500 transition duration-300" />
                    </Link>
                    <Link
                      ...
                      rel="noopener noreferrer"
                    >
                      <FaTwitter className="text-3xl hover:text-teal-500 transition duration-300" />
                    </Link>
                    <Link
                      ...
                      rel="noopener noreferrer"
                    >
                      <FaInstagram className="text-3xl hover:text-teal-500 transition duration-300" />
                    </Link>
                  </div>
                </div>
              </div>
